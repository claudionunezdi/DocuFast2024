...
class ArchivesManager(
    ...
    suspend fun createArchive(
        ...
        // 4) Create the complete File
        val file = File(
            name = fileName,
            creationDate = SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss'Z'", Locale.US).format(Date()),
    ...
    suspend fun deleteArchive(archiveId: String, groupId: String) {
